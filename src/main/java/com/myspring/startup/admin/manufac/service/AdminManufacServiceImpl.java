...
//	제조사검색
	@Override
	public List<AdminManufacVO> AdminManufacSearch(String name) {
		List searchList = adminManufacDAO.selectByManufac(name);
		return searchList;
	}

//	제조사승인거절
	@Override
	public void AdminManufacApproval(AdminManufacVO adminManufacVO) {
		adminManufacDAO.updateManufacApprovalStatus(adminManufacVO);
